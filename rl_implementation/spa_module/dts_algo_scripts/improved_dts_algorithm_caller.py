...
def dts_algo(system_data, user_data):
    '''
    ...
    for server in range(uav_count):  # DTS algo considers only 2-tier architecture, uavs and cloud server
...
def main(system_data, user_data, fraction_bins=10):
    matching, mli_matching = dts_algo(system_data, user_data)
